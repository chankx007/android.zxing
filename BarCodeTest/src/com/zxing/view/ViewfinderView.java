 ...
 * ÔøΩ‘∂ÔøΩÔøΩÔøΩÔøΩViewÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ ±ÔøΩ–ºÔøΩÔøΩÔøΩ æÔøΩÔøΩ
 */
public final class ViewfinderView extends View {
  ...
  private static final int  ALPHA= 0xA5;   //**Õ∏√˜∂»
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (resultBitmap != null) {
      ...
      drawFrame(canvas, frame);				//**¿L—u∞◊…´ﬂÖøÚ
      drawFrameCorner(canvas, frame);		//**¿L—u4ÇÄæG…´ﬂÖΩ«
      ...
      int move = frame.top + slideTop;      //**íﬂ√ËæÄ—≠≠hùLÑ”
